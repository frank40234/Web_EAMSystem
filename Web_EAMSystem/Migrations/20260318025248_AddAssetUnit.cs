...
{
    /// <inheritdoc />
    public partial class AddAssetUnit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ASSET_UNIT_ID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ASSET_UNIT = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetUnits", x => x.ASSET_UNIT_ID);
                });
        }
